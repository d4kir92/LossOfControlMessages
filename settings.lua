...
function LocMessages:InitSetting()
	...
	LocMessages:SetVersion(AddonName, 135860, "1.2.48")
	loc_settings = LocMessages:CreateFrame(
		{
			...
			["sw"] = 520,
			["sh"] = 520,
			["title"] = format("LOC Messages |T135860:16:16:0:0|t v|cff3FC7EB%s", "1.2.48")
		}
	)
	...
	LocMessages:CreateMinimapButton(
		{
			...
			["icon"] = 135860,
			["dbtab"] = LOCTABPC,
			["vTT"] = {{"LocMessages |T135860:16:16:0:0|t", "v|cff3FC7EB1.2.48"}, {"Leftclick", "Toggle Settings"}, {"Rightclick", "Hide Minimap Icon"}},
			["funcL"] = function()
